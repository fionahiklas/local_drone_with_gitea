...
INSERT INTO user VALUES(1,'giteaadmin','giteaadmin','','giteaadmin@mailinator.com',0,'enabled','040b2c7f13a3dd2496494a961a13f9f75206ba064e77b30431c57ee6afe1823ef364df7f7a7d0f2154b40b5a01e27655b199','pbkdf2',0,0,0,'',0,'','','Oqz3YM4mnP','Dt0dMuU0QC','','',1574284750,1574284750,0,0,-1,1,1,0,0,1,0,'b9326b9583b1517b8d951fb41fe7aff1','giteaadmin@mailinator.com',0,0,0,0,0,0,0,0,0,'','gitea');
INSERT INTO user VALUES(2,'sandbox','sandbox','','sandbox@mailinator.com',0,'enabled','4cb29b7b4c4564612f9beca9a3eac747018d93f9f20e197439af1492804e753f8d24cd9cd240224e1f8aa60c59e717ea9c2d','pbkdf2',0,0,0,'',0,'','','JIGwuGOUaw','UMD4fuuwm9','en-US','',1574284793,1574284793,1574284793,0,-1,1,0,0,0,1,0,'09a055682622d6f35943930767460173','sandbox@mailinator.com',0,0,0,0,0,0,0,0,0,'','gitea');
...
CREATE TABLE `repository` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `owner_id` INTEGER NULL, `lower_name` TEXT NOT NULL, `name` TEXT NOT NULL, `description` TEXT NULL, `website` TEXT NULL, `original_service_type` INTEGER NULL, `original_url` TEXT NULL, `default_branch` TEXT NULL, `num_watches` INTEGER NULL, `num_stars` INTEGER NULL, `num_forks` INTEGER NULL, `num_issues` INTEGER NULL, `num_closed_issues` INTEGER NULL, `num_pulls` INTEGER NULL, `num_closed_pulls` INTEGER NULL, `num_milestones` INTEGER DEFAULT 0 NOT NULL, `num_closed_milestones` INTEGER DEFAULT 0 NOT NULL, `is_private` INTEGER NULL, `is_empty` INTEGER NULL, `is_archived` INTEGER NULL, `is_mirror` INTEGER NULL, `status` INTEGER DEFAULT 0 NOT NULL, `is_fork` INTEGER DEFAULT 0 NOT NULL, `fork_id` INTEGER NULL, `is_template` INTEGER DEFAULT 0 NOT NULL, `template_id` INTEGER NULL, `size` INTEGER DEFAULT 0 NOT NULL, `is_fsck_enabled` INTEGER DEFAULT 1 NOT NULL, `close_issues_via_commit_in_any_branch` INTEGER DEFAULT 0 NOT NULL, `topics` TEXT NULL, `avatar` TEXT NULL, `created_unix` INTEGER NULL, `updated_unix` INTEGER NULL);
...
CREATE TABLE `pull_request` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `type` INTEGER NULL, `status` INTEGER NULL, `conflicted_files` TEXT NULL, `issue_id` INTEGER NULL, `index` INTEGER NULL, `head_repo_id` INTEGER NULL, `base_repo_id` INTEGER NULL, `head_branch` TEXT NULL, `base_branch` TEXT NULL, `merge_base` TEXT NULL, `has_merged` INTEGER NULL, `merged_commit_id` TEXT NULL, `merger_id` INTEGER NULL, `merged_unix` INTEGER NULL);
...
CREATE TABLE `label` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `repo_id` INTEGER NULL, `name` TEXT NULL, `description` TEXT NULL, `color` TEXT NULL, `num_issues` INTEGER NULL, `num_closed_issues` INTEGER NULL);
...
CREATE TABLE `team` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `org_id` INTEGER NULL, `lower_name` TEXT NULL, `name` TEXT NULL, `description` TEXT NULL, `authorize` INTEGER NULL, `num_repos` INTEGER NULL, `num_members` INTEGER NULL, `includes_all_repositories` INTEGER DEFAULT 0 NOT NULL);
...
CREATE TABLE `tracked_time` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `issue_id` INTEGER NULL, `user_id` INTEGER NULL, `created_unix` INTEGER NULL, `time` INTEGER NULL);
...
CREATE TABLE `repo_indexer_status` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `repo_id` INTEGER NULL, `commit_sha` TEXT NULL);
...
CREATE TABLE `reaction` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `type` TEXT NOT NULL, `issue_id` INTEGER NOT NULL, `comment_id` INTEGER NULL, `user_id` INTEGER NOT NULL, `created_unix` INTEGER NULL);
...
CREATE TABLE `review` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `type` INTEGER NULL, `reviewer_id` INTEGER NULL, `issue_id` INTEGER NULL, `content` TEXT NULL, `created_unix` INTEGER NULL, `updated_unix` INTEGER NULL);
...
INSERT INTO oauth2_application VALUES(1,2,'drone','8af4ed1b-6591-4c1e-9646-a92e4091f5d2','$2a$10$aIa/MQdFOvWykufPqOtrt.YnD6iZrQzzGK5yMZ9OLwVly/eQr.xe.','["http://drone/login"]',1574285357,1574285394);
...
INSERT INTO oauth2_authorization_code VALUES(1,1,'6qLdpbb-k1cT-Ec7Kh9HNiLaSOxvz04XsZQYLSEy44Q=','','','http://drone/login',0);
...
INSERT INTO oauth2_grant VALUES(1,2,1,0,1574287655,1574287655);
...
INSERT INTO version VALUES(1,109);
...
INSERT INTO sqlite_sequence VALUES('oauth2_application',1);
INSERT INTO sqlite_sequence VALUES('oauth2_grant',1);
INSERT INTO sqlite_sequence VALUES('oauth2_authorization_code',2);
